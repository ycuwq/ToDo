...
class DayItemAttrs {
	...
	private int textSizeTop = 14;                              //日历的日期字体
	private int textSizeBottom = 8;                            //节日，阴历的字体
	private @ColorInt int textColorTop = Color.BLACK;        //日历的日期颜色
	private @ColorInt int textColorBottom = Color.parseColor("#999999");   //节日，阴历的日期颜色

	private @ColorInt int backgroundColor = Color.WHITE;    //背景颜色
	private Drawable clickBg;
	private @ColorInt int clickTextColor = Color.WHITE;
